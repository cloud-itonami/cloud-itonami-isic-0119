# Operator Quickstart — Other Non-Perennial Crop Growing Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0119** (`cloud-itonami-isic-0119`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0119.git
cd cloud-itonami-isic-0119
```
...
- Likely source path: `othercropops.governor.cljc`
