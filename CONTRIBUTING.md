...
**Maturity: `:implemented`** — `src/othercropops/` implements the reference
OtherCropOpsAdvisor / FieldOperationsGovernor actor as a synchronous stub
...
crop/jurisdiction reference-data expansion in `othercropops.facts`. Open
